...
export interface ApiApvApv extends Struct.CollectionTypeSchema {
  collectionName: 'apvs';
  info: {
    displayName: 'Apv';
    pluralName: 'apvs';
  ...
  attributes: {
    ...
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::apv.apv'> &
      Schema.Attribute.Private;
...
export interface ApiGlobalGlobal extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    autorizadas: Schema.Attribute.Integer;
    citasAgendadas: Schema.Attribute.Integer;
    citasReales: Schema.Attribute.Integer;
    Contactos: Schema.Attribute.Integer;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    demos: Schema.Attribute.Integer;
    desembolsos: Schema.Attribute.Integer;
    docCompleta: Schema.Attribute.Integer;
    entregas: Schema.Attribute.Integer;
    ...
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    viablesPreAutorizadas: Schema.Attribute.Integer;
  };
}

export interface ApiNumeroApvNumeroApv extends Struct.CollectionTypeSchema {
  collectionName: 'numero_apvs';
  info: {
    displayName: 'Numero_apv';
    pluralName: 'numero-apvs';
    singularName: 'numero-apv';
  };
  options: {
    draftAndPublish: true;
  };
